...
if (isset($_GET['med_id'])) {
  $med_id = $_GET['med_id'];
  $medications = (new MedicationController)->getMedicationById($med_id);
}
?>
  ...
  <main class="flex items-center justify-center lg:col-span-7 xl:col-span-6">
    <div class="max-w-xl lg:max-w-3xl">
      ...
      <p class="mt-4 leading-relaxed text-gray-500">
        Update the details below for the selected medication.
      </p>
      ...
      <form method="post" class="mt-8 grid grid-cols-6 gap-6">
        ...
        <div class="col-span-6">
          ...
          <input
            ...
            id="medname"
            name="med_name"
            value="<?php echo htmlspecialchars($medications['med_name'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
        ...
        <div class="col-span-6 sm:col-span-3">
          ...
          <input
            ...
            id="dosage"
            name="dosage"
            value="<?php echo htmlspecialchars($medications['dosage'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
            class="mt-1 p-2 w-full rounded-md border-2 border-gray-200 bg-white text-sm h-10 text-gray-700 shadow-sm" />
        </div>
        ...
        <div class="col-span-6 sm:col-span-3">
          ...
          <input
            ...
            id="frequency"
            name="frequency"
            value="<?php echo htmlspecialchars($medications['frequency'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
            class="mt-1 p-2 w-full rounded-md border-2 border-gray-200 bg-white text-sm h-10 text-gray-700 shadow-sm" />
        </div>
        ...
        <div class="col-span-6 sm:col-span-3">
          ...
          <input
            ...
            id="interval"
            name="interval"
            value="<?php echo htmlspecialchars($medications['interval'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
            class="mt-1 p-2 w-full rounded-md border-2 border-gray-200 bg-white text-sm h-10 text-gray-700 shadow-sm" />
        </div>
        ...
        <div class="col-span-6 sm:col-span-3">
          <label for="start_time" class="block text-sm font-medium text-gray-700">
            Start Time(eg. 8AM)<sup class="text-gray-400">(optional)</sup>
          </label>
          <input
            type="time"
            id="start_time"
            name="start_time"
            value="<?php echo htmlspecialchars($medications['start_time'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
            class="mt-1 p-2 w-full rounded-md border-2 border-gray-200 bg-white text-sm h-10 text-gray-700 shadow-sm" />
        </div>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  (new MedicationController)->updateMedication();
}
?>